...
namespace CinemaProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            ApplicationDbContext db)
        {
            ...
            _logger = logger;
            _emailSender = emailSender; _db = db;
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList=_roleManager.Roles.Where(x=>x.Name!=Other.Role_User)
                .Select(x=>x.Name)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(Other.Role_Customer))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(Other.Role_Customer));
                    }
